   ...
   public class StoreManagetTest
    {
        ...
        public void TestInitialize()
        {
            ...
            store1 = StoreTest.openStore(storeId: 1, user: userManger.GetUser("liav"), inv: inv_store_1, rank: 4);
            ...
            store2 = StoreTest.openStore(storeId: 2, user: userManger.GetUser("sundy"), inv: inv_store_2, rank: 3);
            ...
            store3 = StoreTest.openStore(storeId: 3, user: userManger.GetUser("yosef"), inv: inv_store_3, rank: 1);
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.appendProduct(int, string, int, string, double, string, string, int)
        ...
        /// <func cref ="eCommerce_14a.StoreManagment.appendProduct(int, string, int, string, double, string, string, int)
        public Tuple<bool, string> appendProductDriver(int storeId, string userName, int Pid, string pDetails, double price, string pName, string pCategory, int amount)
        {
            return storeManagment.appendProduct(storeId, userName, Pid, pDetails, price, pName, pCategory, amount);
        }

        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.removeProduct(int, string, int)
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.UpdateProduct(string, int, int, string, double, string, string)
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.addProductAmount(int, string, int, int)
        ...
        /// <func cref ="eCommerce_14a.StoreManagment.addProductAmount(int, string, int, int)
        public Tuple<bool, string> addProductAmountDriver(int storeId, string userName, int productId,int amount) 
        {
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.decraseProductAmount(int, string, int, int)
        ...
        /// <func cref ="eCommerce_14a.StoreManagment.getStoreInfo(int)
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.changeStoreStatus(string, int, bool)
        ...
        [TestMethod]
        /// <func cref ="eCommerce_14a.StoreManagment.getStore(int)
        ...
        /// <func cref ="eCommerce_14a.StoreManagment.getStore(int)
        public Store getStoreDriver(int storeId)
        {
        ...
        /// <func cref ="eCommerce_14a.StoreManagment.getStore(int)
        public Dictionary<int, Store> getActiveStoreDriver()
        {
