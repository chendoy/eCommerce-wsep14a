...
namespace TestingSystem.UnitTests
{
    ...
    public class SearcherTest
    {
        ...
        public void TestInitialize()
        {
            ...
            lstProds.Add(new Tuple<Product, int>(new Product(3, name:"MegaMix", price: 1000, rank: 5, category: "Kitchen"), 300));
            lstProds.Add(new Tuple<Product, int>(new Product(4, name:"makeup loreal paris", price: 200, rank: 3, category: "Beauty"), 0));
            ...
            lstProds2.Add(new Tuple<Product, int>(new Product(1, price: 650, name: "Keyboard Mx95 Lgoitech", rank: 4, category: "Computers"), 100));
            lstProds2.Add(new Tuple<Product, int>(new Product(2, name: "Elctricty Knife", price: 450, rank: 5, category: "Kitchen"), 200));
            lstProds2.Add(new Tuple<Product, int>(new Product(3, name:"MegaMix v66", price: 1500, rank: 1, category: "Kitchen"), 300));
            lstProds2.Add(new Tuple<Product, int>(new Product(4, name:"Lipstick in955", price: 200, rank: 3, category: "Beauty"), 10));
            ...
            lstProd3.Add(new Tuple<Product, int>(new Product(1, price: 50, name: "Mouse Mx95 Lgoitech", rank: 2, category: "Computers"), 100));
            lstProd3.Add(new Tuple<Product, int>(new Product(2, name: "Nespresso Latsima Touch Coffe Machine", price: 1400, rank: 2, category: "Kitchen"), 200));
            lstProd3.Add(new Tuple<Product, int>(new Product(3, name:"MegaMix v41", price: 1500, rank: 4, category: "Kitchen"), 300));
            lstProd3.Add(new Tuple<Product, int>(new Product(4, name:"makeup loreal paris", price: 200, rank: 5, category: "Beauty"), 10));
